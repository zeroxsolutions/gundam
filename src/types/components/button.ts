...
export type typeVariant = "primary" | "secondary" | "tertiary" | "ghost" | "link" | "outline" | "danger" | "text"
...
export const propTypesIcon: PropTypes.Requireable<PropTypes.ReactNodeLike> = PropTypes.node
